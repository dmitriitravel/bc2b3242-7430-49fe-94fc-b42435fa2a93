...
export const SupportingSection5 = () => {
  return (
      ...
      <div className="container mx-auto px-4">
        ...
        <section className="text-center">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Всё, что нужно знать о переходе в онлайн-школу для обучения в 5 классе
            </p>
          </div>
              ...
              <AccordionItem value="transition" className="bg-white rounded-2xl border border-gray-200 px-6">
                <AccordionTrigger className="text-left text-lg font-semibold hover:no-underline py-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <span>Можно ли перейти в онлайн-школу в середине 5 класса?</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="text-left text-gray-600 pb-6 ml-13 leading-relaxed">
              ...
              <AccordionItem value="program" className="bg-white rounded-2xl border border-gray-200 px-6">
                <AccordionTrigger className="text-left text-lg font-semibold hover:no-underline py-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <span>По какой программе идет обучение в 5 классе?</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="text-left text-gray-600 pb-6 ml-13 leading-relaxed">
                  Все онлайн-школы работают по государственным федеральным образовательным стандартам (ФГОС). 
                  Программа 5 класса включает все обязательные предметы: русский язык, литературу, математику, 
                  историю, обществознание, географию, биологию, иностранный язык, 
                  информатику, ОБЖ, физкультуру и технологию. Некоторые школы предлагают углубленное изучение отдельных предметов.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="schedule" className="bg-white rounded-2xl border border-gray-200 px-6">
                <AccordionTrigger className="text-left text-lg font-semibold hover:no-underline py-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <span>Сколько времени в день нужно заниматься в 5 классе?</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="text-left text-gray-600 pb-6 ml-13 leading-relaxed">
              ...
              <AccordionItem value="cost" className="bg-white rounded-2xl border border-gray-200 px-6">
                <AccordionTrigger className="text-left text-lg font-semibold hover:no-underline py-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <span>Сколько стоит обучение в онлайн-школе для 5 класса?</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="text-left text-gray-600 pb-6 ml-13 leading-relaxed">
              ...
              <AccordionItem value="support" className="bg-white rounded-2xl border border-gray-200 px-6">
                <AccordionTrigger className="text-left text-lg font-semibold hover:no-underline py-6">
                  <div className="flex items-center space-x-3">
                    ...
                    <span>Есть ли поддержка и кураторы для учеников 5 класса?</span>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="text-left text-gray-600 pb-6 ml-13 leading-relaxed">
